...
TEST(IsInputIncomplete, TrailingLogicalAnd) {
  EXPECT_TRUE(InputChecker::isInputIncomplete("true &&"));
}

TEST(IsInputIncomplete, TrailingLogicalOr) {
  EXPECT_TRUE(InputChecker::isInputIncomplete("false ||"));
}
